...
void loop(void)
{
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////
  int L1 = 0;
  if (T > (t1+1) && T < (t2-1))    L1 = 255;
  if (T >= (t0+1) && T < (t1+1) )  L1 = (T - t0) * 255 / (t1 - t0);
  if (T >= (t2-1) && T < (t3+1) )  L1 = 255 - (T - t2) * 255 / (t3 - t2);
  ////////////////////////////////////////////////////////////////////////////////////////////////
  int L2 = 0;
  if (T < t0) L2 = 100;
  if (T > t3) L2 = 100;
  if (T >= t0  && T < t1)  L2 = 100 - (T - t0) * 100 / (t1 - t0);
  if (T >= t2 && T < t3 )  L2 = (T - t2) * 100 / (t3 - t2);
  ////////////////////////////////////////////////////////////////////////////////////////////////
  int L3 = 0;
  if (T > (t0 - 2) && T < (t1 - 2)) L3 = 255;
  if (T > (t2 + 2)) L3 = 255;
  ////////////////////////////////////////////////////////////////////////////////////////////////
  int L4 = 0;
  if (T < t1) {
